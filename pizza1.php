...
<html lang="en">
    ...
    <body style="background-image: url('pizza.jpg');">
        ...
        <?php
            ...
            $cphone=$_POST['phone'];
            $cadd=$_POST['add'];
            $sql="insert into pizzaOrder (custname, custnum, custadd) values('$cname', '$cphone', '$cadd')";
         ...
         if(isset($_POST['update']))
            ...
            $cphone=$_POST['phone'];
            $cadd=$_POST['add'];
            $sql="update pizzaOrder set custname='".$cname."', custadd='".$cadd."' where custnum='".$cphone."'";
            $query=mysqli_query($conn, $sql);
            if($query)
            {
